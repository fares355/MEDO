...
if res ~= 200 then
print('\27[0;31m┉ ┉  ŤURBON┉ ┉ ┉ ┉  ŤURBON┉ ┉ ┉ ┉\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na┉ ┉  ŤURBON┉ ┉ ┉ ┉  ŤURBON┉ ┉ ┉ ┉\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m┉ ┉  ŤURBON┉ ┉ ┉ ┉  ŤURBON┉ ┉ ┉ ┉ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua MEDO.lua')
end
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ┉  ŤURBON┉ ┉ ┉ ┉  ŤURBON┉ ┉ ┉ ┉  ŤURBON┉ ┉ ┉ ┉ ┉┉ ┉  ŤURBON┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "┉ ┉  ŤURBON┉ ┉ ┉ ┉  ŤURBON┉ ┉ ┉ ┉  ŤURBON┉ ┉ ┉ ┉  ŤURBON┉ ┉ ┉ ┉ ┉ ┉ ┉"
exit 1
fi
if [ ! $token ]; then
echo "┉ ┉  ŤURBON┉ ┉ ┉ ┉  ŤURBON┉ ┉ ┉ ┉  ŤURBON┉ ┉ ┉ ┉  ŤURBON┉ ┉ ┉ ┉  ŤURBON┉ ┉ ┉"
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./MEDO.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("GT", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MEDOTEAM/Files_MEDO/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1059262308,999815838,656329268}   
...
var = true  
elseif tonumber(user_id) == tonumber(999815838) then
var = true  
elseif tonumber(user_id) == tonumber(656329268) then
var = true  
...
MEDO_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
MEDO_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
MEDO_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
MEDO_Msg = 'امبروطور التفاعل' 
...
--------------------------------------------------------------------------------------------------------------
function SourceMEDO(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,MEDO_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf MEDO.lua')
os.execute('wget https://raw.githubusercontent.com/fares355/MEDO/main/MEDO.lua')
send(msg.chat_id_, msg.id_,' ☆↯⇠ تم تحديث السورس \n ☆↯⇠ لديك اخر اصدار لسورس تيربون\n ☆↯⇠ الاصدار » { 1.3v}')
dofile('MEDO.lua')  
end
if text == 'الاصدار ☆↯' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☆↯⇠ اصدار سورس تيربون\n ☆↯⇠ الاصدار »{ 1.3v}')
end
...
send(msg.chat_id_, msg.id_,'☆↯⇠  عدد الجروبات الان » { '..#group..' }'..MEDOk..''..MEDO..'\n☆↯⇠  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ☆↯⇠ العضو » ['..result.title_..'](t.me/'..(username or 'ChBa3os')..')'
status  = '\n ☆↯⇠ تم ترقيته مطور'
...
usertext = '\n ☆↯⇠ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ChBa3os')..')'
status  = '\n ☆↯⇠ تم ترقيته مطور'
...
local MEDO1_Msg = database:get(bot_id.."MEDO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if MEDO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆↯⇠ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ChBa3os')..') \n ☆↯⇠ '..MEDO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if MEDO_Msg and not Special(msg) then  
local MEDO_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if MEDO_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ☆↯⇠ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ☆↯⇠ ["..MEDO_Msg.."] \n")
else
send(msg.chat_id_,0," ☆↯⇠ العضو : {["..data.first_name_.."](T.ME/ChBa3os)}\n ☆↯⇠ ["..MEDO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☆↯⇠ عذرا » {["..data.first_name_.."](T.ME/ChBa3os)}\n ☆↯⇠ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == "مسح رساله الاشتراك ☆↯" and SudoBot(msg) then  
...
Text = [[
↯♡  ━━━  ᵴᵉᴌẤ  ━━━ ↯♡
 [- The Source Developer ](https://t.me/BA3OS) ☆ .
  [- The Source Developer ](https://t.me/IIBA3OS) ☆ .
 [- The SOURCE channel](https://t.me/ChBa3os) ☆ .
↯♡  ━━━  ᵴᵉᴌẤ  ━━━ ↯♡
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☆↯⇠ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ChBa3os')..') \n ☆↯⇠ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆↯⇠ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ChBa3os')..') \n ☆↯⇠ تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber(656329268) then
...
if result.sender_user_id_ == tonumber(999815838) then
send(msg.chat_id_, msg.id_, " ☆↯⇠ لا يمكنك حظر مطور السورس \n")
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☆↯⇠ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ChBa3os')..')'
status  = '\n ☆↯⇠ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☆↯⇠ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☆↯⇠ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ChBa3os')..')'
...
database:set(bot_id.."MEDO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."MEDO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ☆↯⇠ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."MEDO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."MEDO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."MEDO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."MEDO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ☆↯⇠ تم منع الكلمه مع التحذير")  
database:del(bot_id.."MEDO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."MEDO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."MEDO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."MEDO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ☆↯⇠ ارسل الكلمه الان")  
database:set(bot_id.."MEDO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."MEDO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."MEDO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MEDO1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."MEDO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."MEDO1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."MEDO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MEDO1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."MEDO1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ☆↯⇠ قائمة المنع \n≪↯━━━━━━ͲᴱⱤPỔᵑ━━━━━━━↯≫\n"
for k,v in pairs(list) do  
local MEDO_Msg = database:get(bot_id.."MEDO1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..MEDO_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☆↯⇠ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'ChBa3os')..')'..'\n ☆↯⇠ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تيربون').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تيربون')
local MEDO_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..MEDO_Msg[math.random(#MEDO_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تيربون').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ChBa3os')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
MEDOdx(msg.chat_id_, msg.id_, ' ☆↯⇠ ايدي المجموعة » ( '..msg.chat_id_..' )\n ☆↯⇠ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ☆↯⇠ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ☆↯⇠ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_, t..'ٴ☆↯⇠ٴ≪━━━━━━Sᵉ⍸Ầ━━━━━━≫ٴ☆↯⇠○ٴ\n☆↯⇠ 彡 .[Sᵉ⍸Ầ C𝐇𝐀𝐍𝐍𝐄𝑳](t.me/ChBa3os)➢ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تيربون')
...
MEDO = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(MEDO)
...
------------------------------------------------------------------------
local MEDOAbot = database:get(bot_id.."MEDO1:Add:Filter:Rp2"..text..result.chat_id_)   
if MEDOAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ☆↯⇠ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ☆↯⇠ ["..MEDOAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local MEDO1_Msg = database:get(bot_id.."MEDO1:Add:Filter:Rp2"..text..result.chat_id_)   
if MEDO1_Msg then    
send(msg.chat_id_, msg.id_," ☆↯⇠ "..MEDO1_Msg)
